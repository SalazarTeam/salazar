...
class ProgressionsPanel extends React.Component {
	...
	render() {
		var progressionsStatus = "progressions-panel";
		if (this.props.overhaulStatus === "--overhaul-inactive") {
			progressionsStatus = "--overhaul-hide-progressions";
		}
		...
		return (
			<div className={ progressionsStatus }>
